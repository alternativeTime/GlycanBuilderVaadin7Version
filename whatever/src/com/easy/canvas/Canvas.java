package com.easy.canvas;

import java.util.ArrayList;
import java.util.List;

import com.easy.canvas.client.ui.CanvasClientRpc;
import com.easy.canvas.client.ui.CanvasServerRpc;
...
public class Canvas extends AbstractComponent {
	...
	public void cubicCurveTo(double cp1x, double cp1y, double cp2x,
		...
		rpc.cubicCurveTo(cp1x, cp1y, cp2x,
				cp2y, x, y);		
	}
