...
public class Rhombus extends BaseShape{

	public Rhombus(double x, double y, double w, double h, ResidueStyle style,Canvas canvas,boolean selected) {
		super(x, y, w, h, style, canvas,selected);
	}

	@Override
	protected void paintShape() {
		BaseShape.createRhombus(x, y, w, h, canvas);
		canvas.fill();
