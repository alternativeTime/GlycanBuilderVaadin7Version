...
public class SquareBracket extends BaseShape{
	...
	public SquareBracket(double angle,double x, double y, double w, double h, ResidueStyle style,
	...
	protected void paintShape() {
		...
		BaseShape.createSquareBracket((BasicCanvas)canvas, angle, x, y, w, h);
		setStrokeColour(style.getShapeColor());
		canvas.stroke();
	}
